...
class CacheConfig {
    ...
    lateinit var expirationTime: java.time.Duration

    @Bean
    fun cacheManager(): CacheManager {
        return object : ConcurrentMapCacheManager(STATE_CACHE, INPUT_DATA_CACHE) {
    ...
    companion object {
        ...
        const val INPUT_DATA_CACHE = "inputDataCache"
    }
}